function meg_msFigs_TE_allTrials_mdlFit_slope_bar
% meg_msFigs_TE_allTrials_mdlFit_slope_bar
...
if saveFigs
    if plotSubjects
        figTitle = sprintf('meg_manuscriptFigs_TE_allTrials_mdlFit_slope_bar_subjects');
    else
        figTitle = sprintf('meg_manuscriptFigs_TE_allTrials_mdlFit_slope_bar');
    end
