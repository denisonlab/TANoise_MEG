function meg_Fig5c_TE_byPrecue_mdlFit_freq_bar
...
%% Load data 
filename = 'figData/ModelFit_freeFreq_session.mat';
load(filename)
...
if saveFigs
    if plotSubjects
        figTitle = sprintf('Fig5c_TE_byPrecue_mdlFit_freq_bar_subjects');
    else
        figTitle = sprintf('Fig5c_TE_byPrecue_mdlFit_freq_bar');
    end
