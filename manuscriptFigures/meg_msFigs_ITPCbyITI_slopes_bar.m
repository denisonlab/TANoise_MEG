function meg_msFigs_ITPCbyITI_slopes_bar
...
if saveFigs
    if plotSubjects
        figTitle = sprintf('meg_manuscriptFigs_ITPCbyITI_slopes_bar_subjects');
    else
        figTitle = sprintf('meg_manuscriptFigs_ITPCbyITI_slopes_bar');
    end
