...
figDir = sprintf('/Users/kantian/Dropbox/github/ta-meg-analysis2/manuscriptFigures/figs');
% figDir = sprintf('/Users/kantian/Dropbox/Data/TANoise/Manuscript_Figs/%s',dateStr); % 221004_updates
if ~exist(figDir, 'dir')
    mkdir(figDir)
end
...
%% Plot Bars of d' and RT (CCN 2024) 
figure
...
% T1 invalid 
x = repmat(2+xJitter,[10,1]); 
e = errorbar(x(1),mean(dprime.T2.cueT1),std(dprime.T2.cueT1)/sqrt(10),'Marker','.','MarkerSize',gSize,'MarkerFaceColor',p.cueColors(8,:),'MarkerEdgeColor',p.cueColors(8,:),...
    'Color',p.cueColors(8,:),'LineWidth',2);
e.CapSize = capSize; 
...
ylabel({'Orientation \itd''\rm'},'FontSize',18,'FontWeight','light')
% ylabel('Orientation','FontSize',18)
xticks([1 2])
xticklabels({'T1','T2'})
ylim([0 2.3])
...
ax = gca;
ax.FontName = 'Helvetica'; 
ylabel({'Reaction time (s)'},'FontSize',18,'FontWeight','light')
xticks([1 2])
xticklabels({'T1','T2'})
ylim([0 1.25])
...
%% Plot single subject d' and rt on separate figures
for iS = 1:numel(subjectNames)
    ...
    hold on
    % Precue T1 line
    s = plot([1 2],[dprime.T1.cueT1(iS) dprime.T2.cueT1(iS)],'Color',subjectColor);
    % Precue T2 line
    s = plot([1 2],[dprime.T1.cueT2(iS) dprime.T2.cueT2(iS)],'Color',subjectColor);
    % T1
    scatter(1,dprime.T1.cueT1(iS),gSize*3,'filled','MarkerFaceColor',p.cueColors(1,:),'MarkerFaceAlpha',1,'MarkerEdgeColor','w') % precue T1
    scatter(1,dprime.T1.cueT2(iS),gSize*3,'filled','MarkerFaceColor',p.cueColors(2,:),'MarkerFaceAlpha',1,'MarkerEdgeColor','w') % precue T2
    % T2
    scatter(2,dprime.T2.cueT2(iS),gSize*3,'filled','MarkerFaceColor',p.cueColors(2,:),'MarkerFaceAlpha',1,'MarkerEdgeColor','w') % precue T2
    scatter(2,dprime.T2.cueT1(iS),gSize*3,'filled','MarkerFaceColor',p.cueColors(1,:),'MarkerFaceAlpha',1,'MarkerEdgeColor','w') % precue T1
    ...
    hold on
    % Precue T1 line
    s = plot([1 2],[rt.T1.cueT1(iS) rt.T2.cueT1(iS)],'Color',subjectColor); 
    % Precue T2 line
    s = plot([1 2],[rt.T1.cueT2(iS) rt.T2.cueT2(iS)],'Color',subjectColor); 
    % T1
    scatter(1,rt.T1.cueT1(iS),gSize*3,'filled','MarkerFaceColor',p.cueColors(1,:),'MarkerFaceAlpha',1,'MarkerEdgeColor','w') % precue T1 
    scatter(1,rt.T1.cueT2(iS),gSize*3,'filled','MarkerFaceColor',p.cueColors(2,:),'MarkerFaceAlpha',1,'MarkerEdgeColor','w') % precue T2 
    % T2
    scatter(2,rt.T2.cueT2(iS),gSize*3,'filled','MarkerFaceColor',p.cueColors(2,:),'MarkerFaceAlpha',1,'MarkerEdgeColor','w') % precue T2  
    scatter(2,rt.T2.cueT1(iS),gSize*3,'filled','MarkerFaceColor',p.cueColors(1,:),'MarkerFaceAlpha',1,'MarkerEdgeColor','w') % precue T1  
    ...
    sgtitle(sprintf('%s',subjectNames{iS}))

    if saveFigs
        figTitle = sprintf('dP_rt_%s',subjectNames{iS});
        saveas(gcf,sprintf('%s/%s.svg', figDir, figTitle))
    end
end
