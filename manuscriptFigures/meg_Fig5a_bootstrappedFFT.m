function meg_Fig5a_bootstrappedFFT
% function meg_Fig5a_bootstrappedFFT
% see meg_fftPlayground for full figs
% also makes supplemental Fig 2 (set timeOI to 'baseline') 
...
filename = 'figData/groupA_ITPCspectrogram_byAtt.mat'; 
...
if saveFigs
    figTitle = sprintf('Fig5a_bootstrappedFFT_%s_t%d-%d',varOI,t(1),t(end));
