function meg_msFigs_TE_byPrecue_mdlFit_2Hz_bars
...
for iP = 1:3
    ...
    if saveFigs
        if plotSubjects
            figTitle = sprintf('meg_msFigs_TE_byPrecue_mdlFit_2Hz_bar_%s_subjects',paramOI);
        else
            figTitle = sprintf('meg_msFigs_TE_byPrecue_mdlFit_2Hz_bar_%s',paramOI);
        end
