...
user = 'kantian'; 
% filename =
% sprintf('/Users/%s/Dropbox/github/ta-meg-analysis-model/model_anticipatory/ModelFit_1_freeFreq_GroupTS_231102.mat',user);
% only 1 permutation 
filename = sprintf('/Users/%s/Dropbox/github/ta-meg-analysis-model/model_anticipatory/ModelFit_1_freeFreq_group_231220.mat',user); 
load(filename)
        ...
        for iC = 1:numel(cueLevel)
            ...
            switch fitTypes{iF}
                case 'linear2Hz'
                    ...
                    fStrTxt.Color = colors.darkPurple; 
                case 'linear'
